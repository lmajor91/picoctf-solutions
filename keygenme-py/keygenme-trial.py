...
def enter_license():
    ...
    user_key+= "54ef6292"
    user_key+= key_part_static2_trial
...
'''
When trying to crack lisence key generation, this is the best function to check.

We see that the key itself is in 3 parts with one part we know we're supposed to edit
In this function we see that b'PRITCHARD' is being hashed and certain characters are being hashed and compared to the inputted key, we can figure out this key by running the code in a python shell and manually hashing the key to which is being compared
'''
...
# key_full_template_trial = key_part_static1_trial + key_part_dynamic1_trial + key_part_static2_trial
    ...
    if len(key) != len(key_full_template_trial):
        ...
        # this is the comparison part here, take this and run it in a
        # python shell
